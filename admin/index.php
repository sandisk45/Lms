      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 ">
          <li class="nav-item mx-3">
            <a class="nav-link active" aria-current="page" href="index.php"><strong>Admin Login</strong></span></a>
          </li>
          <li class="nav-item mx-3">
            <a class="nav-link" aria-current="page" href="signup.php"><strong>Register</strong></span></a>
          </li>
          <li class="nav-item mx-3">
            <a class="nav-link" aria-current="page" href="../index.php"><strong>Home</strong></span></a>
          </li>
        </ul>
      </div>
    </div>
