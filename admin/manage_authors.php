  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="index.php"><strong>Dashboard</strong></a>
        </li>
        </ul>
      </div>
    </div>
        ...
        <form action="">
            <table class="table-bordered "  width="100%" style="text-align:center">
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn" name=""><a class="link-offset-2 link-underline link-underline-opacity-0" href="edit_authors.php?aid=<?php echo $row['author_id']?>">Edit</button>
                        <button class="btn" name=""><a class="link-offset-2 link-underline link-underline-opacity-0" href="delete_authors.php?aid=<?php echo $row['author_id']?>">Delete</a></button>
                    </td>
                </tr>
                <?php
                }
