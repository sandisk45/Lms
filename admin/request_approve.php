...
<html lang="en">
  ...
  <div class="row">
    ...
    <div class="col-md-4">
        <form action="request_books_update.php" method="post">
            <div class="mb-3">
                <label for="name" class="form-label"><strong>Enter The Name Of The Book</strong></label>
                <input type="text" name="request_book_name" class="form-control" required>
            </div>
            <div class="mb-3">
