        ...
        <form action="">
            <table class="table-bordered "  width="100%" style="text-align:center">
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn" name=""><a class="link-offset-2 link-underline link-underline-opacity-0" href="request_approve.php">Approve</button>
                        <button class="btn" name=""><a class="link-offset-2 link-underline link-underline-opacity-0" href="delete_request.php?rn=<?php echo $row['request_id'];?>">Delete</a></button>
                    </td>
