        ...
        <form action="">
            <table class="table-bordered "  width="100%" style="text-align:center">
                ...
                while ($row=mysqli_fetch_assoc($query_run)) {
                    $issued_name=$row['issued_name'];
                    $student_name=$row['student_name'];
                ?>
                <tr>
                    <td><?php echo $issued_name; ?></td>
                    <td><?php echo $student_name; ?></td>
                    <td>
                      <button class="btn" name=""><a class="link-offset-2 link-underline link-underline-opacity-0" href="delete_approved_books.php?appid=<?php echo $row['issued_id'] ?>">Delete</a></button>
                    </td>
                </tr>
                <?php
                }
