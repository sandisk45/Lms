        ...
        <form>
            <table class="table-bordered"  width="100%" style="text-align:center">
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn" name=""><a class="link-offset-2 link-underline link-underline-opacity-0" href="edit_book.php?bn=<?php echo $row['book_no'];?>">Edit</button>
                        <button class="btn" name=""><a class="link-offset-2 link-underline link-underline-opacity-0" href="delete_book.php?bn=<?php echo $row['book_no'];?>">Delete</a></button>
                    </td>
                </tr>
                <?php
                }
