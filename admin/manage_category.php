        ...
        <form action="">
            <table class="table-bordered "  width="100%" style="text-align:center">
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn" name=""><a class="link-offset-2 link-underline link-underline-opacity-0" href="edit_category.php?cid=<?php echo $row['cat_id']?>">Edit</a></button>
                        <button class="btn" name=""><a class="link-offset-2 link-underline link-underline-opacity-0" href="delete_category.php?cid=<?php echo $row['cat_id']?>">Delete</a></button>
                    </td>
                </tr>
                <?php
                }
