  ...
  <div class="row">
    ...
    <div class="col-md-4">
        <form action="request_books_update.php" method="post">
            <div class="mb-3">
                <label for="name" class="form-label"><strong>Enter The Name Of The Books</strong></label>
                <input type="text" name="request_name" class="form-control" required>
            </div>
            <div class="mb-3">
                <label for="name" class="form-label"><strong>Enter Your Name</strong></label>
                <input type="text" name="student_name" class="form-control" required>
            </div>
            <div class="text-center text-md-left">
              <button type="submit" class="btn btn-success">Sent Request</button>
            </div>
